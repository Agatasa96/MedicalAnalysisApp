...
<body>
	<h2>Choose result:</h2>
	<div class="container">
		<a href="/MedicalAnalysis/urine/add">
			<button type="button" class="btn btn-primary btn-lg btn-block">Urine
				test</button>
		</a> <a href="/MedicalAnalysis/morphology/add">
			<button type="button" class="btn btn-secondary btn-lg btn-block">Blood
				morphology test</button>
		</a> <a href="/MedicalAnalysis/bloodGlucose/add">
			<button type="button" class="btn btn-primary btn-lg btn-block">Blood
				glucose test</button>
		</a><a href="/MedicalAnalysis/thyrotropin/add">
