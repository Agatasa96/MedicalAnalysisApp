...
<body>
	...
	<table class="table table-hover">
		<thead>
			<tr>
				<th scope="col">WBC</th>
				<th scope="col">LYMPH</th>
				<th scope="col">MONO</th>
				<th scope="col">EOS</th>
				<th scope="col">BASO</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>${morphologyTest.WBC }</td>
				<td>${morphologyTest.LYMPH }</td>
				<td>${morphologyTest.MONO }</td>
				<td>${morphologyTest.EOS }</td>
				<td>${morphologyTest.BASO }</td>
			</tr>
		</tbody>
	</table>
